        ...
        <div class="relative flex w-full flex-col items-center">
          {#if cameraError}
            ...
            >
              ...
              <p
                class="mb-4 max-w-[280px] text-[11px] leading-relaxed text-slate-500 dark:text-slate-400"
              >
                {m.qr_scanner_hint()}
              </p>
              <button
          ...
          {:else}
            ...
            {#if errorMessage}
              <div
                class="mt-3 flex items-start gap-1.5 rounded-lg bg-rose-50 px-3 py-2 text-xs font-semibold text-rose-700 dark:bg-rose-950/60 dark:text-rose-300"
              >
            ...
            {:else}
              <p
                class="mt-3 max-w-[280px] text-center text-[11px] leading-relaxed text-slate-500 dark:text-slate-400"
              >
                {m.qr_scanner_hint()}
              </p>
            {/if}
